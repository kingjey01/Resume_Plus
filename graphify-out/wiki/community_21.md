...
- **tasks** (`backend_notifications_tasks_py`, File, degree: 16)
...
- **notify_summary_to_validate()** (`backend_notifications_tasks_py_notify_summary_to_validate`, Function, degree: 1)
...
- backend_notifications_tasks_py → backend_notifications_tasks_py_notify_summary_to_validate (defines)
