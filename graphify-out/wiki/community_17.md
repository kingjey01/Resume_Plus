# Community 17: home_screen

**Members:** 20

## Nodes

- **home_screen** (`lib_features_home_screens_home_screen_dart`, File, degree: 19)
...
- **package:resume_plus_clean/features/auth/providers/auth_provider.dart** (`lib_features_home_screens_home_screen_dart_import_package_resume_plus_clean_features_auth_providers_auth_provider_dart`, Module, degree: 1)
...
- **package:resume_plus_clean/models/user.dart** (`lib_features_home_screens_home_screen_dart_import_package_resume_plus_clean_models_user_dart`, Module, degree: 1)
- **package:resume_plus_clean/providers/tab_refresh_provider.dart** (`lib_features_home_screens_home_screen_dart_import_package_resume_plus_clean_providers_tab_refresh_provider_dart`, Module, degree: 1)
...
- lib_features_home_screens_home_screen_dart → lib_features_home_screens_home_screen_dart_import_package_resume_plus_clean_features_auth_providers_auth_provider_dart (imports)
- lib_features_home_screens_home_screen_dart → lib_features_home_screens_home_screen_dart_import_package_resume_plus_clean_models_user_dart (imports)
...
- lib_features_home_screens_home_screen_dart → lib_features_home_screens_home_screen_dart_import_package_resume_plus_clean_providers_tab_refresh_provider_dart (imports)
