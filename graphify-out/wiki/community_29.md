# Community 29: seed_production

**Members:** 17

## Nodes

- **seed_production** (`backend_courses_management_commands_seed_production_py`, File, degree: 17)
...
- **courses.models.FilierePromotion** (`backend_courses_management_commands_seed_production_py_import_courses_models_filierepromotion`, Module, degree: 1)
...
- **courses.models.Promotion** (`backend_courses_management_commands_seed_production_py_import_courses_models_promotion`, Module, degree: 1)
...
- **django.core.management.base.BaseCommand** (`backend_courses_management_commands_seed_production_py_import_django_core_management_base_basecommand`, Module, degree: 1)
- **payments.models.Service** (`backend_courses_management_commands_seed_production_py_import_payments_models_service`, Module, degree: 1)
- **random** (`backend_courses_management_commands_seed_production_py_import_random`, Module, degree: 1)
- **users.models.UserProfile** (`backend_courses_management_commands_seed_production_py_import_users_models_userprofile`, Module, degree: 1)

## Relationships

- backend_courses_management_commands_seed_production_py → backend_courses_management_commands_seed_production_py_import_django_core_management_base_basecommand (imports)
- backend_courses_management_commands_seed_production_py → backend_courses_management_commands_seed_production_py_import_decimal_decimal (imports)
- backend_courses_management_commands_seed_production_py → backend_courses_management_commands_seed_production_py_import_django_contrib_auth_models_user (imports)
- backend_courses_management_commands_seed_production_py → backend_courses_management_commands_seed_production_py_import_users_models_userprofile (imports)
- backend_courses_management_commands_seed_production_py → backend_courses_management_commands_seed_production_py_import_courses_models_course (imports)
- backend_courses_management_commands_seed_production_py → backend_courses_management_commands_seed_production_py_import_courses_models_session (imports)
- backend_courses_management_commands_seed_production_py → backend_courses_management_commands_seed_production_py_import_courses_models_summary (imports)
...
- backend_courses_management_commands_seed_production_py → backend_courses_management_commands_seed_production_py_import_courses_models_filierepromotion (imports)
...
- backend_courses_management_commands_seed_production_py → backend_courses_management_commands_seed_production_py_import_random (imports)
