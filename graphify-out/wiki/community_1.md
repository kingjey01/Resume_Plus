# Community 1: serializers

**Members:** 48

## Nodes

- **serializers** (`backend_courses_serializers_py`, File, degree: 30)
...
- **CourseSerializer** (`backend_courses_serializers_py_courseserializer`, Class, degree: 4)
...
- **FilierePromotionSerializer** (`backend_courses_serializers_py_filierepromotionserializer`, Class, degree: 1)
...
- **.models.FilierePromotion** (`backend_courses_serializers_py_import_models_filierepromotion`, Module, degree: 1)
...
- **.models.UniversiteFiliere** (`backend_courses_serializers_py_import_models_universitefiliere`, Module, degree: 1)
...
- **UniversiteFiliereSerializer** (`backend_courses_serializers_py_universitefiliereserializer`, Class, degree: 1)
...
- backend_courses_serializers_py → backend_courses_serializers_py_import_models_universitefiliere (imports)
- backend_courses_serializers_py → backend_courses_serializers_py_import_models_filierepromotion (imports)
...
- backend_courses_serializers_py → backend_courses_serializers_py_universitefiliereserializer (defines)
- backend_courses_serializers_py → backend_courses_serializers_py_filierepromotionserializer (defines)
