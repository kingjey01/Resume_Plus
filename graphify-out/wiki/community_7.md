...
- **tests** (`backend_courses_tests_py`, File, degree: 17)
...
- **UniversiteFiliereM2MTest** (`backend_courses_tests_py_universitefilierem2mtest`, Class, degree: 3)
- **.setUpTestData()** (`backend_courses_tests_py_universitefilierem2mtest_setuptestdata`, Method, degree: 1)
- **.test_relation_universite_filiere()** (`backend_courses_tests_py_universitefilierem2mtest_test_relation_universite_filiere`, Method, degree: 1)
...
- backend_courses_tests_py → backend_courses_tests_py_universitefilierem2mtest (defines)
- backend_courses_tests_py_universitefilierem2mtest → backend_courses_tests_py_universitefilierem2mtest_setuptestdata (defines)
- backend_courses_tests_py_universitefilierem2mtest → backend_courses_tests_py_universitefilierem2mtest_test_relation_universite_filiere (defines)
